...
file_output = '{0}-nm-sos-results.json'.format(timestamp)

file_saved = os.path.join(dir_current, dir_json, file_output)

target_url = "https://nmresws.azurewebsites.net/NMResultsAjax.svc/GetCandidates?ElectionType=General&ElectionID=0&nocache={0}".format(timestamp.replace("-", ""))
