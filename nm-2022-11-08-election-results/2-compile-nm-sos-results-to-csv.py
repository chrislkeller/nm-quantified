...
class BuildLatestCsv(object):
    ...
    of election results from the New Mexico Secretary of State
    for the 2022-11-08 general election
    """

    timestamp = datetime.datetime.now().strftime("%Y-%m-%d-%H%M%S")
    dir_current = os.path.dirname(os.path.realpath(__file__))
    dir_data = "results-json"
    ...
    def handle(self):
        ...
        latest_csv = "latest-nm-sos-results.csv"
