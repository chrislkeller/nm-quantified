...
class BuildingPermitRequest(object):
    ...
    target_url = 'http://data.cabq.gov/business/buildingpermits/BuildingPermitsCABQ-en-us.csv'
    ...
    output_csv = os.path.join(dir_current, 'week-of-{0}-abq-weekly-commerical-permits.{1}'.format(my_range.strftime('%Y-%m-%d'), 'csv'))

    output_file = os.path.join(dir_current, 'week-of-{0}-abq-weekly-commerical-permits.{1}'.format(my_range.strftime('%Y-%m-%d'), 'txt'))
