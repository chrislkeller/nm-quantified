...
"""
This script pulls down daily snapshots of total sales data by city
...
file_output = "{0}-nm-daily-city-level.json".format(timestamp)

file_saved = os.path.join(dir_current, dir_json, file_output)

target_url = "https://qimw5q0w5j.execute-api.us-west-2.amazonaws.com/prod/GetCitySales"
